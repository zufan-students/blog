---
title: "Subdomain Takeover Tool"
date: 2022-08-12 07:15:00 +07:00
categories: [Tools]
tags: [APPSEC, BLUETEAM, BUGBOUNTY, BUGHUNTER, CYBERSECURITY, DNS, EXPLOIT, HACKING, INFOSEC, MALWARE, PENTEST, REDTEAM, SUBDOMAIN, SUBDOMAINTAKEOVER, VAPT, VULNERABILITY]
image: 
---
...
![DNS Reaper detects a if domain has a broken cname record and can be taken over by registering the domain's cname](https://cdn.discordapp.com/attachments/740245586095112242/1007444564958781472/reaper_detection.png "DNS Reaper detects a if domain has a broken cname record and can be taken over by registering the domain's cname")
